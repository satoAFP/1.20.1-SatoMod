...
public class IntroductionBlockStateProvider extends BlockStateProvider {
    public IntroductionBlockStateProvider(PackOutput output, ExistingFileHelper exFileHelper) {
        super(output, SatoMod.MOD_ID, exFileHelper);
    }

    @Override
    protected void registerStatesAndModels() {
        simpleBlockWithItem(SatoModBlocks.Blocks.SATO_INGOT_BLOCK);
        simpleBlockWithItem(SatoModBlocks.Blocks.YAMAMOTO_ORE_BLOCK);
        simpleBlockWithItem(SatoModBlocks.Blocks.DEEPSLATE_YAMAMOTO_ORE_BLOCK);
